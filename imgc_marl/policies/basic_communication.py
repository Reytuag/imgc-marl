...
class BasicCommunicationTrainer(PPOTrainer):
    def get_default_policy_class(self, config):
        return BasicCommunicationPolicy


class BasicCommunicationPolicy(PPOTorchPolicy):
    def loss(
        self,
        model: ModelV2,
        ...
        return convert_to_numpy(
            {
                ...
                "communication_loss": torch.mean(
                    torch.stack(self.get_tower_stats("communication_loss"))
                ),
            }
        )
